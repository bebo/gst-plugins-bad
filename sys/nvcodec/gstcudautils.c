...
static void
find_cuda_context (GstElement * element)
{
  GstQuery *query;
  GstContext *ctxt;
...
context_set_cuda_context (GstContext * context, GstCudaContext * cuda_ctx)
{
  ...
  if (cuda_ctx)
    GST_CAT_LOG (GST_CAT_CONTEXT,
        "setting GstCudaContext(%" GST_PTR_FORMAT ") on context(%"
        GST_PTR_FORMAT ")", cuda_ctx, context);
...
gst_cuda_ensure_element_context (GstElement * element,
    GstCudaContext ** cuda_ctx, gint device_id)
{
  GstCudaContext *ctx;
...
gst_cuda_handle_set_context (GstElement * element,
    GstContext * context, GstCudaContext ** cuda_ctx, gint device_id)
{
