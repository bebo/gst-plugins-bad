...
struct _GstCudaBaseFilterClass
{
  ...
  gboolean      (*set_info)           (GstCudaBaseFilter *filter,
                                       GstCaps *incaps, GstVideoInfo *in_info,
                                       GstCaps *outcaps, GstVideoInfo *out_info);

  GstFlowReturn (*transform_frame)    (GstCudaBaseFilter *filter,
                                       GstCudaMemoryTarget in_target,
                                       GstVideoFrame *in_frame,
                                       GstCudaMemoryTarget out_target,
